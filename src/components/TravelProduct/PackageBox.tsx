...
const PackageBox = ({ packageData }: { packageData: Package }) => {
  ...
  return (
    ...
    max-xsm:w-full max-xsm:gap-0"
    >
      <div className="max-xsm:px-[16px] w-full max-xsm:mb-[10px]">
        <h1 className="text-main-color text-[20px] max-xsm:text-[14px] max-xsm:mb-[10px]">
      ...
      max-xsm:max-w-[398px] max-xsm:max-h-[217px] max-xsm:rounded-[20px] max-xsm:w-full max-xsm:mb-[17px]"
        >
